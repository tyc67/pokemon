      ...
      <Listbox value={selected} onChange={setSelected}>
        <div className="relative mt-1">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="absolute mt-1 max-h-60 px-1 w-full overflow-auto rounded-md bg-gray-500 py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
